...
# TODO: Docstring
"""
function propagate!(pre::NeuronLayer, post::NeuronLayer, syn::SynapseLayer, fired::BitArray)
    any(fired) || return
    ...
    syn.ws .= max.(0.0, syn.ws .- ltd) # Fixed syn.2s typo
end

"""
# TODO: Docstring
"""
function update_post!(pre::NeuronLayer, post::NeuronLayer, syn::SynapseLayer, postfired::BitArray)
